pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~exemples_memoire_dynamique_leakFix.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~exemples_memoire_dynamique_leakFix.adb");
...
--  BEGIN Object file/option list
   --   ./piles.o
   --   ./exemples_memoire_dynamique_leakFix.o
   --   -L./
