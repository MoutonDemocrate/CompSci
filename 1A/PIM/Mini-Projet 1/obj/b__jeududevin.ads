...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_jeududevin" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#17833091#;
   pragma Export (C, u00001, "jeududevinB");
   ...
   u00006 : constant Version_32 := 16#5e9ebd8f#;
