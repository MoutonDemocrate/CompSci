...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ex1_pgcd" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#969038cd#;
   pragma Export (C, u00001, "ex1_pgcdB");
   ...
   u00143 : constant Version_32 := 16#f95ea4cd#;
